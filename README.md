...
مسیر یادگیری برنامه‌نویسی به زبان فارسی - پروژه اوپن‌سورس

## ویژگی‌ها

- **رودمپ‌های یادگیری**: مسیرهای جامع برای بک‌اند، فرانت‌اند، دواپس و...
...
```
devroad/
├── data/                  # داده‌های JSON (رودمپ‌ها، منابع، مالی)
│   ├── roadmaps/
│   │   ├── index.json    # لیست رودمپ‌ها
│   │   ├── backend.json  # رودمپ بک‌اند
│   │   ├── frontend.json # رودمپ فرانت‌اند
│   │   └── devops.json   # رودمپ دواپس
